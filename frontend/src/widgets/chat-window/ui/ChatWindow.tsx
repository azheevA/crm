"use client";
import { MessageBubble } from "@/src/entities/messages/ui/MessageBubble";
import { useCurrentUser } from "@/src/entities/user/hooks/useCurrentUser";
import { AddMembersModal } from "@/src/features/add-chat-member/ui/AddChatMember";
import { ChatAvatarEditable } from "@/src/features/change-chat-data/ui/ChatAvatarEditable";
import { DeleteChatButton } from "@/src/features/change-chat-data/ui/ChatDeleteButton";
import { getFullImageUrl } from "@/src/features/change-user-data/utils/get-url-image";
import { useChatSocketSync } from "@/src/features/chat-realtime/hooks/useChatSocketSync";
import { useReadMessages } from "@/src/features/chat-realtime/hooks/useReadMessages";
import { useTypingIndicator } from "@/src/features/chat-realtime/hooks/useTypingIndicator";
